...
public class DataSeeder {
    ...
    CommandLineRunner seed(FoodRepository foods, TrainingCategoryRepository trainingCategories,
        ...
        return args -> {
            ...
            ensureFood(foods, "Pechuga de Pollo", "ScaleGrams Premium Select", "7790000000073", FoodCategory.PROTEIN,
            ...
            ensureFood(foods, "Yogur Griego Natural", "ScaleGrams Dairy", "7790000000042", FoodCategory.DAIRY,
            ...
            ensureFood(foods, "Queso crema", "ScaleGrams Dairy", "7790000000463", FoodCategory.DAIRY,
                    342, 8, 4, 34, FoodPreparation.AS_SOLD, "ARGENFOODS 102", Set.of("Lácteo", "Alto en Grasas"));
            ensureFood(foods, "Queso mozzarella", "ScaleGrams Dairy", "7790000000464", FoodCategory.DAIRY,
                    280, 28, 3, 17, FoodPreparation.AS_SOLD, "ARGENFOODS 105", Set.of("Lácteo", "Alta en Proteína"));
            ensureFood(foods, "Queso cottage", "ScaleGrams Dairy", "7790000000465", FoodCategory.DAIRY,
            ...
            ensureFood(foods, "Pasta de maní", "ScaleGrams Select", "7790000000588", FoodCategory.FAT,
